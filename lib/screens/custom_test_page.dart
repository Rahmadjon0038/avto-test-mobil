...
class _CustomTestPageState extends State<CustomTestPage> {
            ...
            child: FutureBuilder<List<TopicQuestion>>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  return _EmptyState(
                    title: strings.t('no_questions_custom'),
                    subtitle: strings.t('no_questions_custom_sub'),
                    buttonText: strings.t('back'),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${_currentIndex + 1}/${questions.length} ${strings.t('questions_label')}',
                                style: TextStyle(
                                  fontSize: 12.5,
  ...
  Future<void> _syncProgress(
    ...
    try {
      await ApiClient.saveCustomTestProgress(
        accessToken: _accessToken,
        testId: widget.ticket.id,
        answers: payload,
      );
